...
public class DataNode {
	...
	public static void main(String[] args) {
		try {
			 ...
			 * Lancement du Thread emetteur de messages toutes les 15 secondes
			 */
			...
			try {
				...
				while (true) {
					...
					if (cmdsplit[0].equals("CMD_READ")) {
						...
						/*Lecture et éprimitives en c fichierscriture des données.*/
						...
						//--------------- Envoi du Bloc au Nouveau DataNode Cible
						System.out.println("Envoi du bloc " + numBlo + " du fichier " + filena + " vers la machine de port " + portNewDN);
